...
GEO_CONSTANTS = tribble(
  ...
  "admin0", "test_admin0.csv", "https://raw.githubusercontent.com/outbreak-info/biothings_covid19/master/geo/countries.json", "+proj=robin",
  ...
  "US_metros", "test_metros.csv", "https://raw.githubusercontent.com/outbreak-info/biothings_covid19/master/geo/US_metro.json", "+proj=laea +lat_0=45 +lon_0=-100 +x_0=0 +y_0=0 +a=6370997 +b=6370997 +units=m +no_defs",
